...
/**
 * Renders the 'Tamiratlar Raporu' (Repairs Report) page with filtering and viewing options.
 * Displays report details and a table of all repairs.
 */
const TamiratlarRaporu2 = () => {
    // Mock data for the report and the side menu.
    const mockReportData = {
        raporAdi: 'Tamiratlar Raporu',
        tarih: new Date().toLocaleDateString('tr-TR'),
        tarihAraligi: 'Ağustos 2025',
        tamiratSayisi: 12,
        toplam: 12500,
        repairs: [
            { id: 1, tarih: '15.08.2025', musteri: 'Ahmet Yılmaz', arac: 'Ford Focus', tamiratlar: 'Motor Tamiri', toplam: 500, teknisyen: 'Ali', giderler: 150, kilometre: 120000 },
            { id: 2, tarih: '14.08.2025', musteri: 'Ayşe Kaya', arac: 'VW Golf', tamiratlar: 'Periyodik Bakım', toplam: 1500, teknisyen: 'Mehmet', giderler: 500, kilometre: 85000 },
            { id: 3, tarih: '13.08.2025', musteri: 'Mehmet Demir', arac: 'BMW 3 Serisi', tamiratlar: 'Fren Balata Değişimi', toplam: 750, teknisyen: 'Can', giderler: 250, kilometre: 65000 },
            { id: 4, tarih: '12.08.2025', musteri: 'Fatma Şahin', arac: 'Mercedes C-Class', tamiratlar: 'Kaporta Onarımı', toplam: 3000, teknisyen: 'Ali', giderler: 1000, kilometre: 150000 },
        ]
    };
        ...
        <div className="flex flex-col md:flex-row min-h-screen">
            ...
            <div className="flex-1 p-6 bg-white rounded-2xl shadow-md">
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                    ...
                    <p className="text-gray-700"><span className="font-semibold">Tamirat Sayısı:</span> {mockReportData.tamiratSayisi}</p>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tamiratlar</th>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Giderler</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kilometre</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                            {mockReportData.repairs.map(repair => (
                                <tr key={repair.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{repair.tarih}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{repair.musteri}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{repair.arac}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{repair.tamiratlar}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {repair.toplam.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{repair.teknisyen}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {repair.giderler.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{repair.kilometre.toLocaleString('tr-TR')}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
...
export default TamiratlarRaporu2;
