...
// Bu bileşen, personel yenileme hatırlatıcılarını yönetmek için kullanılır.
const PersonelYenilemeleri = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 font-inter">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Yaklaşan Personel Yenilemeleri</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          <div>
            ...
            >
              ...
              <option value="is-sozlesmesi">İş Sözleşmesi</option>
              <option value="is-sagligi">İş Sağlığı</option>
            </select>
          </div>
          {/* Personel Arama */}
          <div>
            <label htmlFor="personel-search" className="block text-sm font-medium text-gray-700 mb-1">Personel</label>
            <input
              type="text"
              id="personel-search"
            ...
            {sortedData.length > 0 ? (
              sortedData.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.personel}</td>
...
export default PersonelYenilemeleri;
